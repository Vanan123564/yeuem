...
pygame.display.set_caption("Mãi Yêu")
...
while run:
    ...
    rect1 = yes_button.drawbutton(
        yesColor, yes_posX, yes_posY, 140, 100, 20, yesShadow, 'grey')
    yes_button.drawtext('Arial', 72, 'CÓ', yesTxtcolor)

    no_button = CreateButton(screen)
    rect2 = no_button.drawbutton(
        'green', no_posX, no_posY, 250, 100, 20, 5, 'grey')
    no_button.drawtext('Arial', 72, 'KHÔNG', 'black')
